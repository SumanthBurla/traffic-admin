...
{ 
	...
	$from_email		 = 'sumanthburla12@gmail.com'; //from mail, sender email addrress 
	$recipient_email = $_POST['email']; //recipient email addrress 
	echo  $recipient_email;
	//Load POST data from HTML form 
	$sender_name = 'Traffic_Surviellance_Team'; //sender name 
	$reply_to_email = $from_email; //sender email, it will be used in "reply-to" header 
	$subject	 = 'Challan Generation'; //subject for the email 
	$message	 = 'Pay the challan as per government rules'; //body of the email 
